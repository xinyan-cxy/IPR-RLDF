...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="Whether use k to change the loss.",
    )
    parser.add_argument(
        "--use_reward",
        type=bool,
        default=True,
        help="Whether use reward to change the loss.",
    )
    parser.add_argument(
...
def main():
    ...
    def collate_fn(examples):
        ...
        label = [example["correctness"] for example in examples]
        k = [example["k"] for example in examples]
        return {"pixel_values": pixel_values, "input_ids": input_ids, "label": label, "k": k}
